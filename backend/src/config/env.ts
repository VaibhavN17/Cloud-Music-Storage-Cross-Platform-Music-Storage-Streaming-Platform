...
const envSchema = z.object({
  ...
  R2_BUCKET_PRIVATE: z.string().default('audio-private'),
  R2_BUCKET_PUBLIC: z.string().default('audio-public'),
  R2_BUCKET_ARTWORK: z.string().default('artwork'),
  R2_BUCKET_TEMP: z.string().default('temp'),
